...
GLStateEGL::gotValidDisplay()
{
    ...
    s = egl_query_string(egl_display_, EGL_VENDOR);
    printf("EGL_VENDOR = %s\n", s);

    s = eglQueryString(egl_display_, EGL_VENDOR);
    printf("EGL_VENDOR = %s\n", s);

    s = eglQueryString(egl_display_, EGL_EXTENSIONS);
...
//                nullptr);
    ...
    printf("22222222222233333333333333\n");
...
//    }
    ...
    printf("xxxxxxxxxxxxxxxrrrrrrrrrrrrr\n");
#if GLMARK2_USE_GLESv2
...
#endif
    printf("xxxxxxxxxxxxxxxddddddddddddddd\n");
